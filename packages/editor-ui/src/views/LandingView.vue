  ...
  <div class="bg-background min-h-screen flex flex-col text-on-surface antialiased">
    <header class="w-full h-16 flex justify-between items-center px-margin-page bg-surface-container-lowest border-b border-surface-variant sticky top-0 z-50 shadow-sm">
      ...
      <div class="flex gap-4">
        <button type="button" class="font-label-md text-label-md text-on-surface-variant hover:text-on-surface px-4 py-2 transition-colors" @click="goToLogin">
          Sign In
        </button>
        <button
          type="button"
          class="bg-primary text-on-primary px-4 py-2 rounded-xl font-label-md text-label-md hover:bg-secondary transition-colors shadow-sm"
          @click="goToLogin"
        >
          Start Building
        </button>
      ...
      <section class="w-full px-margin-page py-24 md:py-32 flex flex-col items-center text-center relative overflow-hidden">
        ...
        <div class="z-10 max-w-3xl flex flex-col items-center gap-6">
          ...
          <div class="flex gap-4 mb-16">
            <button
              type="button"
              class="bg-primary text-on-primary px-6 py-3 rounded-xl font-label-md text-label-md hover:bg-secondary transition-colors shadow-sm flex items-center gap-2"
              @click="goToLogin"
            >
              Start Building Free
              <span class="material-symbols-outlined text-[16px]">arrow_forward</span>
            </button>
            <button type="button" class="bg-transparent border border-outline text-on-surface-variant px-6 py-3 rounded-xl font-label-md text-label-md hover:bg-surface-container transition-colors">
              View Documentation
            </button>
          </div>
        </div>
        ...
        <div class="w-full max-w-5xl z-10 relative">
          <div class="bg-surface-container-lowest rounded-xl border border-surface-variant shadow-sm overflow-hidden flex flex-col h-[500px]">
            <div class="h-12 border-b border-surface-variant bg-surface flex items-center justify-between px-4">
              ...
              <div class="flex items-center gap-2">
                <button type="button" class="text-on-surface-variant hover:text-on-surface p-1"><span class="material-symbols-outlined text-[18px]">undo</span></button>
                <button type="button" class="text-on-surface-variant hover:text-on-surface p-1"><span class="material-symbols-outlined text-[18px]">redo</span></button>
                <div class="h-4 w-px bg-surface-variant mx-2"></div>
                <button type="button" class="bg-primary text-on-primary px-3 py-1 rounded font-label-sm text-label-sm">Execute</button>
              </div>
            </div>
